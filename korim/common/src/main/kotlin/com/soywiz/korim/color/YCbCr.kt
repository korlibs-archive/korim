...
object YCbCr : ColorFormat32() {
	...
	@JvmStatic
	fun getY(r: Int, g: Int, b: Int): Int = clamp0_FF((0 + (0.299 * r) + (0.587 * g) + (0.114 * b)).toInt().clamp(0, 255))

	@JvmStatic
	fun getCb(r: Int, g: Int, b: Int): Int = clamp0_FF((128 - (0.168736 * r) - (0.331264 * g) + (0.5 * b)).toInt().clamp(0, 255))

	@JvmStatic
	fun getCr(r: Int, g: Int, b: Int): Int = clamp0_FF((128 + (0.5 * r) - (0.418688 * g) - (0.081312 * b)).toInt().clamp(0, 255))


	@JvmStatic
	fun getR(y: Int, cb: Int, cr: Int): Int = clamp0_FF((y + 1.402 * (cr - 128)).toInt().clamp(0, 255))

	@JvmStatic
	fun getG(y: Int, cb: Int, cr: Int): Int = clamp0_FF((y - 0.34414 * (cb - 128) - 0.71414 * (cr - 128)).toInt().clamp(0, 255))

	@JvmStatic
	fun getB(y: Int, cb: Int, cr: Int): Int = clamp0_FF((y + 1.772 * (cb - 128)).toInt().clamp(0, 255))
